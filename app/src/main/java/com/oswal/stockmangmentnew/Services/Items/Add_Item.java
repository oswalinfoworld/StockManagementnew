...
public class Add_Item extends AppCompatActivity implements OnItemSelectedListener {
    ...
    private String quantitys, dateS, nameS, model_numberS, serial_numberS;
    Button submit, date;
      ...
      /*  quantity = (EditText) findViewById(R.id.additem_quanET);*/
        ...
        category.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(getApplicationContext(),"Category Selected "+categorySelected,Toast.LENGTH_LONG).show();
...
*/
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                oneItem.setCategory(categorySelected);
                ...
                switch (categorySelected) {
                    ...
                    case "Laptop":
                        ...
                        intent.putExtra("model_number", model_number.getText().toString().trim());
                        intent.putExtra("model_Category", categorySelected);
                        intent.putExtra("model_serial_number", serial_number.getText().toString().trim());
                        intent.putExtra("model_date", date.getText().toString().trim());
