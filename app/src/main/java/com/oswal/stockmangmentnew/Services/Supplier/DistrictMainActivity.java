package com.oswal.stockmangmentnew.Services.Supplier;
...
public class DistrictMainActivity extends AppCompatActivity implements DistrictAdapter.ContactsAdapterListener {
