   ...
   /* String[] brandList = {"Select","HP","DEll" };
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              /*  Intent i = new Intent(Switches_activity.this, Add_Item.class);
                ...
                if (isInternetOn()) {
                    new Switches_activity.insertItemToOnlineDB().execute(new ApiConnector());
                    Intent i1 = new Intent(Switches_activity.this, Add_Item.class);
                    startActivity(i1);
                }
            }
        });
    ...
    private class insertItemToOnlineDB extends AsyncTask<ApiConnector, Long, JSONArray> {
        ...
        protected JSONArray doInBackground(ApiConnector... params) {
            ...
            itemSpecification.setPort(no_portS);
